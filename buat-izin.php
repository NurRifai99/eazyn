        ...
        <div class="row">
            <div class="col-lg-8 d-flex align-items-strech">
             <div class="card w-100">
              <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Buat Izin</h5>
              <div class="card">
                <div class="card-body">
                  <form>
                    <div class="mb-3">
                      ...
                      <select class="form-select" aria-label="Default Select Example" name="guru_id">
                        ...
                        <option value="5">Catarina Setyawati</option>
                      </select>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Hingga Jam</label>
                      ...
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">File Pendukung</label>
